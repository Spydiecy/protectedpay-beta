  ...
  return (
    <div className="w-full flex flex-col md:flex-row md:items-stretch md:gap-8">
      ...
      <div className="flex-1 flex flex-col justify-center mt-8 md:mt-0">
        ...
        >
          <h3 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-green-400 to-emerald-500 text-transparent bg-clip-text">
            Payment QR
          </h3>
          <div className="flex flex-col gap-2">
            <p className="text-xl md:text-2xl text-green-400 font-semibold">{username}</p>
