...
const QRContainer: React.FC<QRContainerProps> = ({ 
  ...
  return (
    <div className="relative p-1 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl">
      ...
      <div className="relative bg-black/90 p-4 rounded-lg">
        ...
        <div className="absolute -right-3 top-4 flex flex-col space-y-2">
          {onShare && (
            <motion.button
              onClick={onShare}
              className="p-2 bg-black/80 rounded-xl border border-green-500/20 text-green-400 hover:bg-black/60"
